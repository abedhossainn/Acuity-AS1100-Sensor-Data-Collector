...
def parse_distance_response(response: str) -> Optional[int]:
    ...
    - On-demand measurement: g#g+aaaaaaaa (from s#g command)
    - Tracking/continuous: g#h+aaaaaaaa (from s#h command)
    ...
    try:
        # Format: g0g+00002718 (on-demand) or g0h+00003961 (tracking)
